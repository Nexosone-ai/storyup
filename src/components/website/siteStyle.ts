...
export const SITE_PALETTES: Array<{
  ...
  { id: "forest", name: "포레스트 그린", primary: "#1f6f5a", hover: "#195a49", soft: "#e7f0ec" },
  { id: "ocean", name: "오션 블루", primary: "#1e5f9e", hover: "#174e84", soft: "#e5eef7" },
  { id: "plum", name: "딥 플럼", primary: "#6b4b8a", hover: "#593e74", soft: "#efe9f5" },
  { id: "terracotta", name: "테라코타", primary: "#b85c38", hover: "#9c4c2e", soft: "#f7eae4" },
  { id: "rose", name: "로즈", primary: "#b0446a", hover: "#953a5a", soft: "#f8e9ef" },
  { id: "charcoal", name: "차콜", primary: "#3a3f47", hover: "#2d3138", soft: "#ebedef" },
];
