...
export const translations = {
  ko: {
    ...
    auth: {
      ...
      signupSub: "지금 가입하면 Pro 플랜 1개월 무료 체험이 자동 적용됩니다.",
      resetTitle: "비밀번호 재설정",
    ...
    onboarding: {
      ...
      industryQ: {
        t: "어떤 업종인가요?",
        h: "스토리업 둘러보기에서 같은 업종끼리 모아볼 수 있어요. (선택)",
      },
      industryLabels: {
        food: "음식·카페",
        retail: "쇼핑·유통",
  ...
  en: {
    ...
    auth: {
      ...
      signupSub: "Sign up now and get a 1-month Pro trial automatically.",
    ...
    onboarding: {
      ...
      industryQ: {
        t: "What industry are you in?",
        h: "Lets your page be browsed by category in the STORYUP showcase. (optional)",
      },
      industryLabels: {
        food: "Food & Cafe",
        ...
        service: "Living & Pro Services",
        realestate: "Real Estate & Building",
        travel: "Travel, Leisure & Auto",
        tech: "IT, Marketing & Content",
        manufacturing: "Manufacturing & Industry",
        etc: "Groups, Personal & Other",
      },
    },
  },
};
