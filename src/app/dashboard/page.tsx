    ...
    <div className="space-y-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1.5 text-muted">오늘도 당신의 이야기를 키워볼까요?</p>
        </div>
        <ButtonLink href="/onboarding">
          <Icon.plus className="size-[18px]" />새 비즈니스 만들기
        </ButtonLink>
      </div>
      ...
      <section>
        <h2 className="mb-4 text-lg font-semibold tracking-tight">내 비즈니스</h2>
        {data.businesses.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-border-strong bg-surface px-6 py-16 text-center">
            ...
            <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-muted">
              사업 이야기를 들려주면 AI가 브랜드와 홈페이지, 블로그를
              만들어드립니다. 5분이면 충분해요.
            </p>
            <div className="mt-7">
              <ButtonLink href="/onboarding">
                <Icon.plus className="size-[18px]" />첫 비즈니스 만들기
              </ButtonLink>
            </div>
          </div>
        ) : (
